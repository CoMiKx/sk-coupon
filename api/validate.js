export default async function handler(req, res) {
  // Allow requests from any origin (our own Vercel frontend)
  ...
  const upstream = `https://coupon.netmarble.com/api/coupon/reward?gameCode=tskgb&couponCode=${encodeURIComponent(couponCode)}&langCd=TH_TH&pid=${encodeURIComponent(pid)}`;
